    ...
    <div>
      <div className="w-full h-140 p-4">
        <div className="flex flex-col space-y-4">
          ...
          <h4 className="text-[var(--werent-green-1)] font-medium">Size</h4>
          <SizeSelector />
        </div>
        <div className="flex items-center justify-center hidden sm:flex mt-5 mb-5 gap-3">
          ...
          >
            ...
            >
              <path
                d="m11.645 20.91-.007-.003-.022-.012a15.247 15.247 0 0 1-.383-.218 25.18 25.18 0 0 1-4.244-3.17C4.688 15.36 2.25 12.174 
        ...
        <h4 className="text-[var(--werent-green-1)]">
          ...
          nisl eget ultricies lacinia, nunc nisl aliquam nisl, eget aliquam nunc
          nisl eget nunc. Donec auctor, nisl eget ultricies lacinia, nunc nisl
