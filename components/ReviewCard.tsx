...
function ReviewCard({Review, showPicture}:ReviewProps) {
  ...
  return (
        <div className='bg-white py-7 px-10 flex flex-col gap-2 rounded-xl'>
            ...
            <section className='flex justify-between cursor-pointer'  onClick={() => setIsReviewOpen(true)} >
                <p className='font-size-3'  onClick={() => setIsReviewOpen(true)}>{Review.reviewerName}</p>
                <div className='flex' onClick={()=>(console.log("thank you for your feedback!"))}>
                    ...
                    <p className='font-size-4'>({Review.numUpvotes})</p>
                </div>
            </section>
